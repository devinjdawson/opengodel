...
[←PreviousGRRatio Analysis](https://godelterminal.com/docs/commands/gr.html)[NextDVDDividend Yield→](https://godelterminal.com/docs/commands/dvd.html)
...
![ANR command showing analyst ratings dashboard with consensus, price targets, and individual analyst recommendations](./ANR Command (Analyst Ratings) _ Godel Terminal Docs_files/anr-01.png)
...
![ANR command showing the historical ratings timeline and breakdown by buy, hold, and sell categories](./ANR Command (Analyst Ratings) _ Godel Terminal Docs_files/anr-02.png)

*You can export the analyst ratings table by clicking the **download icon** seen below:*

![ANR command showing the historical ratings timeline and breakdown by buy, hold, and sell categories](./ANR Command (Analyst Ratings) _ Godel Terminal Docs_files/anr-03.png)
...
[Get a demo](https://godelterminal.com/docs/commands/anr#demo)[Login](https://app.godelterminal.com/?page=login)[Sign Up](https://app.godelterminal.com/?page=register)
