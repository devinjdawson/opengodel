...
[NextFAFinancials→](https://godelterminal.com/docs/commands/fa.html)
...
DES is the Godel Terminal command for viewing a company's description page: business overview, price chart, market cap, EPS estimates, and analyst ratings for any stock.

[![](../../assets/docs/des/des-tour.png)](../../assets/docs/des/des-tour.webm)

## How to use DES

**Security Identifier/Ticker Country/Instrument Asset Class DES**

Example: NVDA US EQ DES opens Nvidia's company description and financial overview.

![DES command showing the NVDA snapshot panel with valuation ratios, dividend history, and short interest](./DES Command (Description) _ Godel Terminal Docs_files/des-02.png)

### Snapshot Panel

* **Market Info:** Exchange listing, trading currency, float shares.
* **Company Stats:** Employee count, insider ownership percentage, institutional ownership percentage.
* **Valuation Ratios:** P/Sales, P/Book, EV/EBITDA, EV/R, Enterprise Value, Trailing P/E, Forward P/E.
* **Dividend & Yield:** Trailing yield, forward yield, 5-year average yield, payout ratio, ex-dividend date, dividend payment date.
* **Risk & Sentiment:** Beta, short interest shares, and short ratio.

### Keyboard shortcuts on the DES screen

| Key | Opens |
| --- | --- |
| [G](https://godelterminal.com/docs/commands/g.html "G command reference") | Price graph |
| [N](https://godelterminal.com/docs/commands/n.html "N command reference") | Company news |
| [CHAT](https://godelterminal.com/docs/commands/chat.html "CHAT command reference") | Stock chat room |
| [FA](https://godelterminal.com/docs/commands/fa.html "FA command reference") | Financial analysis |
| [EM](https://godelterminal.com/docs/commands/em.html "EM command reference") | Earnings matrix |
| [ANR](https://godelterminal.com/docs/commands/anr.html "ANR command reference") | Analyst ratings |

## Related commands

* [G Chart](https://godelterminal.com/docs/commands/g.html)
* [N News](https://godelterminal.com/docs/commands/n.html)
* [CHAT Chat](https://godelterminal.com/docs/commands/chat.html)
* [FA Financials](https://godelterminal.com/docs/commands/fa.html)
* [EM Earnings Matrix](https://godelterminal.com/docs/commands/em.html)
...
DES is the Godel Terminal description command.

How do I open DES in Godel Terminal?

Type DES in the terminal, or prefix with a ticker (for example, NVDA US EQ DES).

Is DES available on all plans?

Yes, DES is available on every Godel plan.

Does DES work for ETFs, indices, or non-US securities?

Yes. DES works for ETFs, indices, and non-US securities, not just US stocks.
...
[Get a demo](https://godelterminal.com/docs/commands/des#demo)[Login](https://app.godelterminal.com/?page=login)[Sign Up](https://app.godelterminal.com/?page=register)
