...
[←PreviousDESDescription](https://godelterminal.com/docs/commands/des.html)[NextERNEarnings Estimates→](https://godelterminal.com/docs/commands/ern.html)

[Docs](https://godelterminal.com/docs.html)/
[Commands](https://godelterminal.com/docs.html#commands)/
FA

# FA: Financials Command

FA is the Godel Terminal command for viewing a company's income statement, balance sheet, and cash-flow statement on quarterly and annual bases.

[![](../../assets/docs/fa/fa-03.png)](../../assets/docs/fa/fa-03.webm)

## How to use FA

**Security Identifier/Ticker Country/Instrument Asset Class FA**

Example: NVDA US EQ FA: displays the income statement, balance sheet, and cash-flow statement for Nvidia.

![FA command showing the quarterly income statement with revenue, cost of goods sold, and net income rows](./FA Command (Financials) _ Godel Terminal Docs_files/fa-02.png)

Toggle between **Balance Sheet**, **Income Statement**, and **Cash Flow** views, switch between **Quarterly** and **Yearly** data, and click the **download icon (↓) to export to Excel or JSON.**

![FA financials with the Balance Sheet, Income, and Cash Flow statement tabs, the Quarterly and Yearly toggle, and the download-to-Excel button highlighted](./FA Command (Financials) _ Godel Terminal Docs_files/fa-01-highlights.png)
...
FA is the Godel Terminal financials command.

How do I open FA in Godel Terminal?

Type FA in the terminal, or prefix with a ticker (for example, NVDA US EQ FA).

Is FA available on all plans?

Yes, FA is available on every Godel plan.

Does FA work for ETFs, indices, or non-US securities?

FA is built around individual equities. ETFs and indices do not carry this data, so it is stock-focused; non-US companies appear where the underlying data is available.
...
[Get a demo](https://godelterminal.com/docs/commands/fa#demo)[Login](https://app.godelterminal.com/?page=login)[Sign Up](https://app.godelterminal.com/?page=register)
