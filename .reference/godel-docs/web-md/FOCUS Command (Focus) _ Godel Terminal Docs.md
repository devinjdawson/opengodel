...
[←PreviousQMQuote Monitor](https://godelterminal.com/docs/commands/qm.html)[NextTASTime and Sales→](https://godelterminal.com/docs/commands/tas.html)
...
FOCUS is the Godel Terminal command for displaying live prices for a single security in a stripped-down, distraction-free view.

![FOCUS command showing a single-security live price window with bid, ask, last, and change percentage](./FOCUS Command (Focus) _ Godel Terminal Docs_files/focus-01.webp)

## How to use FOCUS

**Security Identifier/Ticker Country/Instrument Asset Class FOCUS**

Example: NVDA US EQ FOCUS - displays concise live prices for Nvidia.

![Opens a FOCUS component](./FOCUS Command (Focus) _ Godel Terminal Docs_files/focus-02.png)

Opens a FOCUS component

[![](../../assets/docs/focus/focus-anim-poster.png)](../../assets/docs/focus/focus-01.webm)

You can disable the flickering/flashing price by clicking the **gear icon** (⚙️) in the top-right corner to change this.

![FOCUS command showing the compact single-ticker layout with streaming quote and volume indicator](./FOCUS Command (Focus) _ Godel Terminal Docs_files/focus-04.png)
![FOCUS command showing the compact single-ticker layout with streaming quote and volume indicator](./FOCUS Command (Focus) _ Godel Terminal Docs_files/focus-05.png)

You can popout the focus component window onto your native OS desktop by clicking the popout “popout” icon. Safari is recommended for a cleaner window title.

![FOCUS command showing the compact single-ticker layout with streaming quote and volume indicator](./FOCUS Command (Focus) _ Godel Terminal Docs_files/focus-06.png)
![(Popped-out FOCUS on Chrome)](./FOCUS Command (Focus) _ Godel Terminal Docs_files/focus-07.png)

(Popped-out FOCUS on Chrome)

![(Popped-out FOCUS on Safari)](./FOCUS Command (Focus) _ Godel Terminal Docs_files/focus-08.png)

(Popped-out FOCUS on Safari)

## Treasuries

You can also use FOCUS to track U.S. and international government yields. These are the most common Treasury benchmarks across the curve.

Example:

US30Y TRADEWEB GOV FOCUS for U.S. 30-Year Treasury Bond

US10Y TRADEWEB GOV FOCUS for U.S. 10-Year Treasury Note

US5Y TRADEWEB GOV FOCUS for U.S. 5-Year Treasury Note

US2Y TRADEWEB GOV FOCUS for U.S. 2-Year Treasury Note

US3M TRADEWEB GOV FOCUS for U.S. 3-Month Treasury Bill

![FOCUS command showing the compact single-ticker layout with streaming quote and volume indicator](./FOCUS Command (Focus) _ Godel Terminal Docs_files/focus-09.png)

Example:

DE10Y TRADEWEB GOV FOCUS for German 10-Year Government Bond (Bund)

JP10Y TRADEWEB GOV FOCUS for Japanese 10-Year Government Bond (JGB)

UK10Y TRADEWEB GOV FOCUS for U.K. 10-Year Government Bond (Gilt)

![FOCUS command showing the compact single-ticker layout with streaming quote and volume indicator](./FOCUS Command (Focus) _ Godel Terminal Docs_files/focus-10.png)

## Currency pairs

FOCUS supports major FX pairs as well. Below are the most widely traded currency pairs, covering the U.S. dollar crosses and key emerging markets.

Common examples:

EURUSD FX1 CUR FOCUS for Euro / U.S. Dollar

USDJPY FX1 CUR FOCUS for U.S. Dollar / Japanese Yen

GBPUSD FX1 CUR FOCUS for British Pound / U.S. Dollar

USDCHF FX1 CUR FOCUS for U.S. Dollar / Swiss Franc

USDCAD FX1 CUR FOCUS for U.S. Dollar / Canadian Dollar

AUDUSD FX1 CUR FOCUS for Australian Dollar / U.S. Dollar

NZDUSD FX1 CUR FOCUS for New Zealand Dollar / U.S. Dollar

USDCNY FX1 CUR FOCUS for U.S. Dollar / Chinese Yuan

USDRUB FX1 CUR FOCUS for U.S. Dollar / Russian Ruble

![FOCUS command showing the compact single-ticker layout with streaming quote and volume indicator](./FOCUS Command (Focus) _ Godel Terminal Docs_files/focus-11.png)

## Cryptocurrencies

You can also monitor digital assets with FOCUS. Here are the most commonly traded cryptocurrencies.

Example:

BTCUSD CRYPTO CUR FOCUS for Bitcoin / U.S. Dollar

ETHUSD CRYPTO CUR FOCUS for Ethereum / U.S. Dollar

XRPUSD CRYPTO CUR FOCUS for Ripple (XRP) / U.S. Dollar

SOLUSD CRYPTO CUR FOCUS for Solana / U.S. Dollar

USDTUSD CRYPTO CUR FOCUS for Tether / U.S. Dollar

USDCUSD CRYPTO CUR FOCUS for USD Coin / U.S. Dollar

![FOCUS command showing the compact single-ticker layout with streaming quote and volume indicator](./FOCUS Command (Focus) _ Godel Terminal Docs_files/focus-12.png)

## Indices

FOCUS works for equity indices too. These are the benchmarks most traders and investors watch daily, from the S&P 500 to volatility indices.

Example:

SPX CBOE IDX FOCUS for S&P 500 Index

NDX GIDS IDX FOCUS for Nasdaq-100 Index

DJI GODEL IDX FOCUS for Dow Jones Industrial Average

RUT GODEL IDX FOCUS for Russell 2000 Index

IXIC GODEL IDX FOCUS for Nasdaq Composite Index

VIX CBOE IDX FOCUS for Cboe Volatility Index (30-day)

![FOCUS command showing the compact single-ticker layout with streaming quote and volume indicator](./FOCUS Command (Focus) _ Godel Terminal Docs_files/focus-13.png)

## Futures

FOCUS supports futures contracts across asset classes.

Example:

ES1 GODEL FUT FOCUS for E-mini S&P 500 Futures

NQ1 GODEL FUT FOCUS for E-mini Nasdaq-100 Futures

ZT1 GODEL FUT FOCUS for 2-Year U.S. Treasury Note Futures

ZF1 GODEL FUT FOCUS for 5-Year U.S. Treasury Note Futures

ZN1 GODEL FUT FOCUS for 10-Year U.S. Treasury Note Futures

ZB1 GODEL FUT FOCUS for 30-Year U.S. Treasury Bond Futures

GC1 GODEL FUT FOCUS for Gold Futures

SI1 GODEL FUT FOCUS for Silver Futures

![FOCUS command showing the compact single-ticker layout with streaming quote and volume indicator](./FOCUS Command (Focus) _ Godel Terminal Docs_files/focus-14.png)
...
FOCUS is the Godel Terminal focus command.

How do I open FOCUS in Godel Terminal?

Type FOCUS in the terminal, or prefix with a ticker (for example, NVDA US EQ FOCUS).

Is FOCUS available on all plans?

Yes, FOCUS is available on every Godel plan.

Does FOCUS work for ETFs, indices, or non-US securities?

Yes. FOCUS works for ETFs, indices, and non-US securities, not just US stocks.
...
[Get a demo](https://godelterminal.com/docs/commands/focus#demo)[Login](https://app.godelterminal.com/?page=login)[Sign Up](https://app.godelterminal.com/?page=register)
