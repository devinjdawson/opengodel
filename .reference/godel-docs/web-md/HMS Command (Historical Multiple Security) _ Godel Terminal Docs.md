...
[←PreviousGChart](https://godelterminal.com/docs/commands/g.html)[NextHPHistorical Prices→](https://godelterminal.com/docs/commands/hp.html)
...
![HMS command showing historical multi-security comparison chart with normalized performance across several tickers](./HMS Command (Historical Multiple Security) _ Godel Terminal Docs_files/hms-01.png)
...
![Godel Terminal command bar showing HMS typed with the COMMANDS autocomplete suggesting 'Launches Historical Multiple Security'](./HMS Command (Historical Multiple Security) _ Godel Terminal Docs_files/hms-02.png)

**Add tickers**

Click into **Add a ticker**, search a symbol, and press **Enter** to add.

![HMS Add a ticker input with a symbol search and the resulting series added to the comparison chart](./HMS Command (Historical Multiple Security) _ Godel Terminal Docs_files/hms-03.png)

**Remove tickers**

Hover the color swatch next to a ticker in the legend and click to remove.

![HMS legend showing the color swatch hover state used to remove a ticker from the chart](./HMS Command (Historical Multiple Security) _ Godel Terminal Docs_files/hms-04.png)
...
![HMS command showing historical multi-security comparison chart with normalized performance across several tickers](./HMS Command (Historical Multiple Security) _ Godel Terminal Docs_files/hms-05.png)

**Metric dropdown**

Toggle the y-axis between **Change %** and **$ Value**. The chart and y-axis relabel automatically.

![HMS command showing historical multi-security comparison chart with normalized performance across several tickers](./HMS Command (Historical Multiple Security) _ Godel Terminal Docs_files/hms-06.png)
...
[Get a demo](https://godelterminal.com/docs/commands/hms#demo)[Login](https://app.godelterminal.com/?page=login)[Sign Up](https://app.godelterminal.com/?page=register)
