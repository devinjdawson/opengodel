...
[←PreviousFXForex Pairs](https://godelterminal.com/docs/commands/fx.html)[NextHDSHolders→](https://godelterminal.com/docs/commands/hds.html)

[Docs](https://godelterminal.com/docs.html)/
[Commands](https://godelterminal.com/docs.html#commands)/
MOST

# MOST: Most Active Command

MOST is the Godel Terminal command for viewing the most active securities of the current session: ranked by volume, change, or gainers/losers.

[![](../../assets/docs/most/most-01.png)](../../assets/docs/most/most-01.webm)
...
![MOST command bar launching the Most Active Securities window](./MOST Command (Most Active) _ Godel Terminal Docs_files/most-04.png)

Launches Most Active Securities

## What MOST shows

| Item | Description |
| --- | --- |
| **Active** | Securities with the highest trading volume |
| **Gainers** | Top percentage gainers |
| **Losers** | Top percentage decliners |
| **Value** | Securities with the highest dollar volume traded |
...
| **Vol $** | Dollar volume, calculated as price times shares traded |
| **M Cap** | Market capitalization |
| **Time** | Last trade timestamp |

![MOST command showing most active securities by volume with ticker, price, change percentage, and volume](./MOST Command (Most Active) _ Godel Terminal Docs_files/most-02.png)

### Filter Controls

| Filter | Description |
| --- | --- |
| **Results Count** | Dropdown to select 10, 25, 50, or 100 results. The default is 25. |
| **Min Cap** | Minimum market cap filter. The default is 500m. |
| **Max Cap** | Maximum market cap filter. The default is no upper limit. |
| **Sector Filter** | All-sector dropdown covering Financial Services, Healthcare, Technology, Industrials, Consumer Cyclical, Basic Materials, Energy, Real Estate, Communication Services, Consumer Defensive, and Utilities. |

![MOST command showing filter controls for result count, market cap range, and sector](./MOST Command (Most Active) _ Godel Terminal Docs_files/most-03.png)

### Ticker Click Behavior

Click any ticker to open its default view. This behavior can be customized in settings [PDF](https://godelterminal.com/docs/commands/pdf.html "PDF command reference").

![MOST command showing ticker click behavior from the most active securities table](./MOST Command (Most Active) _ Godel Terminal Docs_files/most-05.png)

## Related commands

* [TOP Top News](https://godelterminal.com/docs/commands/top.html)
* [TREND Trending on Godel](https://godelterminal.com/docs/commands/trend.html)
* [HALT Market Halts](https://godelterminal.com/docs/commands/halt.html)

## FAQ

What does MOST do?

MOST is the Godel Terminal most active command.

How do I open MOST in Godel Terminal?

Type MOST in the terminal.

Is MOST available on all plans?

Yes, MOST is available on every Godel plan.
...
[Get a demo](https://godelterminal.com/docs/commands/most#demo)[Login](https://app.godelterminal.com/?page=login)[Sign Up](https://app.godelterminal.com/?page=register)
