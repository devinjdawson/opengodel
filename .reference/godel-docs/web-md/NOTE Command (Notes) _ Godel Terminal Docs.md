...
[←PreviousALAlerts](https://godelterminal.com/docs/commands/al.html)[NextENTEntitlements→](https://godelterminal.com/docs/commands/ent.html)
...
![NOTE window showing the Notes editor with a New tab, formatting toolbar (B, I, U, H1, H2, H3, bullet list, numbered list, link), an 'Enter some text…' placeholder, and a Cmd+S to save status bar](./NOTE Command (Notes) _ Godel Terminal Docs_files/note-01.png)
...
![Godel Terminal command bar showing NOTE typed with the COMMANDS autocomplete suggesting 'Rich Text Notes Editor'](./NOTE Command (Notes) _ Godel Terminal Docs_files/note-02.png)
...
* [HELP Help](https://godelterminal.com/docs/commands/help.html)
...
[Get a demo](https://godelterminal.com/docs/commands/note#demo)[Login](https://app.godelterminal.com/?page=login)[Sign Up](https://app.godelterminal.com/?page=register)
