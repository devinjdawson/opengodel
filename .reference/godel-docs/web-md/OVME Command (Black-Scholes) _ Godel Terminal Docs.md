...
[←PreviousOMONOption Chain](https://godelterminal.com/docs/commands/omon.html)[NextCALCCalculator→](https://godelterminal.com/docs/commands/calc.html)
...
![Godel Terminal command bar showing AAPL US EQ OVME typed with the COMMANDS autocomplete suggesting 'Black-Scholes Calculator'](./OVME Command (Black-Scholes) _ Godel Terminal Docs_files/ovme-01.png)

**Global:**

OVME: opens the calculator empty; enter the spot price manually.

![Godel Terminal command bar showing OVME typed with the COMMANDS autocomplete suggesting 'Black-Scholes Calculator'](./OVME Command (Black-Scholes) _ Godel Terminal Docs_files/ovme-02.png)
...
* OVME is a pricing calculator: it is not a live-quote options chain. For an actual options chain, use [OMON](https://godelterminal.com/docs/commands/omon.html "OMON command reference").
...
* [OMON Option Chain](https://godelterminal.com/docs/commands/omon.html)
* [CALC Calculator](https://godelterminal.com/docs/commands/calc.html)
...
[Get a demo](https://godelterminal.com/docs/commands/ovme#demo)[Login](https://app.godelterminal.com/?page=login)[Sign Up](https://app.godelterminal.com/?page=register)
