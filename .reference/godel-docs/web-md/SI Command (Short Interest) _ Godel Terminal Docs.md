...
[←PreviousEMEarnings Matrix](https://godelterminal.com/docs/commands/em.html)[NextGRRatio Analysis→](https://godelterminal.com/docs/commands/gr.html)
...
![SI command showing historical short interest chart for a company with shares short, short ratio, and days to cover](./SI Command (Short Interest) _ Godel Terminal Docs_files/si-01.png)
...
![SI command showing historical short interest chart for a company with shares short, short ratio, and days to cover](./SI Command (Short Interest) _ Godel Terminal Docs_files/si-02.png)

### **Data & Time Controls**

**Reporting Frequency: t**wice monthly via FINRA (typically mid-month and month-end).

**Latest Report Date: d**isplayed at the top of the screen

**Time Period: u**se the From/To date fields to adjust the chart timeframe

**Default View: o**ne year of data

**Extended History: c**an display multiple years of historical short interest trends (if available)

**Refresh: u**pdates to latest available data

![SI command showing historical short interest chart for a company with shares short, short ratio, and days to cover](./SI Command (Short Interest) _ Godel Terminal Docs_files/si-03.png)
...
* [HDS Holders](https://godelterminal.com/docs/commands/hds.html)
* [DVD Dividend Yield](https://godelterminal.com/docs/commands/dvd.html)
...
[Get a demo](https://godelterminal.com/docs/commands/si#demo)[Login](https://app.godelterminal.com/?page=login)[Sign Up](https://app.godelterminal.com/?page=register)
