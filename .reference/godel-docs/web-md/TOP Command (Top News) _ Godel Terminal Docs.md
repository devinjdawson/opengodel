...
[←PreviousNNews](https://godelterminal.com/docs/commands/n.html)[NextTRENDTrending on Godel→](https://godelterminal.com/docs/commands/trend.html)

[Docs](https://godelterminal.com/docs.html)/
[Commands](https://godelterminal.com/docs.html#commands)/
TOP

# TOP: Top News Command

TOP is the Godel Terminal command for viewing a live feed of the top Reuters news headlines, ranked directly by Reuters.

![TOP command showing top news headlines from Reuters with timestamps and source bylines](./TOP Command (Top News) _ Godel Terminal Docs_files/top-01.png)
...
![Launches Top News](./TOP Command (Top News) _ Godel Terminal Docs_files/top-02.png)

Launches Top News

![TOP command showing top news headlines from Reuters with timestamps and source bylines](./TOP Command (Top News) _ Godel Terminal Docs_files/top-03.png)

Use the **↑ / ↓ arrow keys** to navigate headlines and **press Enter** to open the full article for the selected story. You can also click a headline directly.

![TOP command showing top news headlines from Reuters with timestamps and source bylines](./TOP Command (Top News) _ Godel Terminal Docs_files/top-04.png)

**Text-to-Speech (TTS):** Click the speaker icon to have a top news headline read aloud. Your local TTS settings: including voice, speed, and for the top headlines: can be managed from the audio icon on the top-right of the terminal.

![TOP command showing top news headlines from Reuters with timestamps and source bylines](./TOP Command (Top News) _ Godel Terminal Docs_files/top-05.png)

## Ranking Logic

The list is a **Reuters-ranked Top 15.** It’s **not sorted by time**: the order comes from Reuters’ curated Top News feed and **updates live** as priorities change.

## Display Columns

| Column | Description |
| --- | --- |
| **Rank** | Reuters-assigned priority (1 = highest importance) |
| **Headline** | Reuters story title (scrolls if too long) |
| **Time** | Local publication timestamp |
...
TOP is the Godel Terminal top news command.

How do I open TOP in Godel Terminal?

Type TOP in the terminal.

Is TOP available on all plans?

Yes, TOP is available on every Godel plan.
...
[Get a demo](https://godelterminal.com/docs/commands/top#demo)[Login](https://app.godelterminal.com/?page=login)[Sign Up](https://app.godelterminal.com/?page=register)
