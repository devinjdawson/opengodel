...
[←PreviousHCPHistorical Change %](https://godelterminal.com/docs/commands/hcp.html)[NextWEIFWorld Equity Index Futures→](https://godelterminal.com/docs/commands/weif.html)

[Docs](https://godelterminal.com/docs.html)/
[Commands](https://godelterminal.com/docs.html#commands)/
WEI

# WEI: World Equity Index Command

WEI is the Godel Terminal command for monitoring real-time prices of the world's major equity indices.

[![](../../assets/docs/wei/wei-01.png)](../../assets/docs/wei/wei-01.webm)

*Note: A "D" next to any ticker indicates that quote is delayed.*
...
![Launches the World Equity Index component.](./WEI Command (World Equity Index) _ Godel Terminal Docs_files/wei-02.png)

Launches the World Equity Index component.

### Navigation

Click any ticker to open its chart view by default. This click behavior for WEI can be customized in your settings (accessible via the command [PDF](https://godelterminal.com/docs/commands/pdf.html "PDF command reference")).

![WEI command showing world equity index prices with live quotes for S&P 500, Nasdaq, FTSE, DAX, Nikkei, and Hang Seng](./WEI Command (World Equity Index) _ Godel Terminal Docs_files/wei-03.png)

## Related commands

* [WEIF World Equity Index Futures](https://godelterminal.com/docs/commands/weif.html)
...
WEI is the Godel Terminal world equity index command.

How do I open WEI in Godel Terminal?

Type WEI in the terminal.

Is WEI available on all plans?

WEI requires a paid plan. Free (piker) accounts cannot open it.

Does WEI work for ETFs, indices, or non-US securities?

WEI is purpose-built for the world's major equity indices. For individual equities use QM or DES; for index futures use WEIF.
...
[Get a demo](https://godelterminal.com/docs/commands/wei#demo)[Login](https://app.godelterminal.com/?page=login)[Sign Up](https://app.godelterminal.com/?page=register)
